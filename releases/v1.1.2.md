...
- **Security Remediation**: Addressed severity vulnerabilities affecting prototype pollution, method injection, and process hanging in NodeJS dependencies (`flatted`, `picomatch`, `brace-expansion`).
