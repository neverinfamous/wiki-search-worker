        ...
        <main>
            ...
            <section class="examples" id="examples-section">
                ...
                <div class="about-box" id="about-section">
                    ...
                    <p><strong>D1 Database Manager v1.1.0:</strong> Modern web application for managing Cloudflare D1 databases with Time Travel point-in-time recovery, Read Replication for global distribution, TypeScript strict mode (100+ fixes), and Job History tracking. Features complete CRUD operations, visual foreign key editor with ReactFlow graphs, cascade impact simulator, circular dependency detector, FTS5 full-text search designer, undo/rollback system, index analyzer, constraint validator, advanced row filters, column management, SQL query console with syntax highlighting and CSV export, and dark/light themes. Includes Docker deployment and Cloudflare Access Zero Trust authentication.</p>
