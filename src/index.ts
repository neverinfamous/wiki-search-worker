...
html[data-theme="light"]{--primary-color:#2563eb;--text-color:#1f2937;--text-muted:#6b7280;--border-color:#e5e7eb;--background:#fff;--background-alt:#f9fafb}html[data-theme="light"] .site-header{background:rgba(255,255,255,.95)}html[data-theme="light"] .social-btn.reddit{color:#FF4500;border-color:#FF4500}html[data-theme="light"] .social-btn.discord{color:#5865F2;border-color:#5865F2}html[data-theme="dark"]{--primary-color:#60a5fa;--text-color:#f9fafb;--text-muted:#d1d5db;--border-color:#374151;--background:#111827;--background-alt:#1f2937}html[data-theme="dark"] .site-header{background:rgba(17,24,39,.95)}html[data-theme="dark"] .about-box a:hover{color:#93c5fd}html[data-theme="dark"] .social-btn.reddit{color:#FF7B54;border-color:#FF7B54}html[data-theme="dark"] .social-btn.discord{color:#7289DA;border-color:#7289DA}@media (prefers-color-scheme:dark){html:not([data-theme]){--primary-color:#60a5fa;--text-color:#f9fafb;--text-muted:#d1d5db;--border-color:#374151;--background:#111827;--background-alt:#1f2937}.site-header{background:rgba(17,24,39,.95)}.about-box a:hover{color:#93c5fd}.social-btn.reddit{color:#FF7B54;border-color:#FF7B54}.social-btn.discord{color:#7289DA;border-color:#7289DA}}
    </style>
    <script>
    (function() {
...
<body>
    ...
    <nav class="mobile-nav" id="mobile-nav">
        ...
        <div class="mobile-nav-links">
            ...
            <button id="theme-toggle-mobile" class="nav-link" title="Toggle theme" aria-label="Theme: System">
    ...
    <script>
        ...
        const themeConfig = {
            ...
            system: { icon: '💻', label: 'Theme: System', title: 'Toggle theme (currently: System)' }
        };
