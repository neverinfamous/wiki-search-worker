        ...
        <main>
            ...
            <section class="examples" id="examples-section">
                ...
                <div class="about-box" id="about-section">
                    ...
                    <p><strong>DO Manager:</strong> Full-featured management platform for Cloudflare Durable Objects with namespace auto-discovery, instance tracking, and SQL console for SQLite-backed DOs. Features Query Builder with pre-built templates, saved queries per namespace, batch operations (download, delete, backup), instance cloning with full storage copy, instance diff for side-by-side comparison, color tags for organization, R2 backup and restore, metrics dashboard with request volume and CPU time, health dashboard with stale instance detection and storage quota alerts, global cross-namespace search, and event-driven webhooks with HMAC verification. Includes Cloudflare Access Zero Trust authentication.</p>
